...
- [ ] The affected Apple app schemes build (`Strand` and/or `NOOPiOS`) for app-layer changes
...
- [ ] I did not commit generated output (`Strand.xcodeproj/`) or any secrets/signing material
