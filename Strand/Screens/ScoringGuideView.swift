            ...
            ScrollViewReader { proxy in
                ScrollView {
                    VStack(alignment: .leading, spacing: NoopMetrics.sectionGap) {
                        introCard
                        scoreCard(.charge,
                                  headline: String(localized: "Recovery: how ready are you today?"),
                                  ...
                                  vsWhoop: String(localized: "Same question as WHOOP’s Recovery % — and now the same name — but our weighting and baseline maths are our own, and openly documented."))
                        scoreCard(.effort,
