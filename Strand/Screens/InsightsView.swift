        ...
        ScreenScaffold(title: "Insights", subtitle: "Interrogate what affects what.",
            ...
            if !loaded {
                ...
                VStack(alignment: .leading, spacing: NoopMetrics.sectionSpacing) {
                    ...
                    // The card owns its own answers now (it re-reads the day itself), so it takes the
                    // host's live day key instead of pre-read answer dictionaries — that is what makes a
                    // rollover under an open screen move the answers off the "Today" pill.
