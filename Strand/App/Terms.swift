...
/// full text lives in `TERMS.md`, shipped with Noop Aura.
enum Terms {
    ...
    static let points: [(String, String)] = [
        (String(localized: "Independent: not affiliated with WHOOP"),
         String(localized: "Noop Aura is an unofficial project: not affiliated with, endorsed by, or sponsored by WHOOP, Inc. \"WHOOP\" is their trademark, used only to name the hardware Noop Aura works with.")),
        (String(localized: "Using Noop Aura may breach WHOOP's Terms of Service"),
        ...
        (String(localized: "Experimental: at your own risk"),
         String(localized: "Noop Aura talks to your strap's firmware over an unofficial, independently-mapped protocol. There is a residual risk to the device, its data, and its connection to official services. You assume that risk.")),
        (String(localized: "Not a medical device, not medical advice"),
         String(localized: "Every metric is an unvalidated approximation. Don't use Noop Aura to diagnose, treat, or make any health decision. Always consult a qualified professional.")),
        (String(localized: "No warranty; liability limited"),
         String(localized: "Noop Aura is free and provided \"as is\", with no warranty. Liability is limited to the maximum extent the law that applies to you allows, and nothing here removes protections your local law won't let us remove.")),
    ]
    ...
    static let attestations: [String] = [
        String(localized: "I am not a WHOOP employee, contractor, or affiliate, and I am not using Noop Aura on WHOOP's behalf."),
        String(localized: "I own the WHOOP device I will use with Noop Aura and will only use it to access my own data. Doing so is my decision and my risk, including any effect on my WHOOP account, subscription, device, or warranty, and it may breach WHOOP's Terms of Service."),
        String(localized: "I understand Noop Aura is unofficial and experimental, is provided free and \"as is\" with no warranty, and is not a medical device or medical advice."),
        String(localized: "To the fullest extent the law allows, I will not hold the Noop Aura project or its contributors liable for any loss or damage arising from my use of it."),
    ]
}
