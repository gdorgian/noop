    ...
    static func live(
        ...
        let signals: [Signal] = [
            ...
            Signal(id: "resp", name: String(localized: "Breathing"),
                   ...
                   systemImage: "lungs", usesStateAccent: false, tint: Color(hex: "#8B99D6"),
                   series: series { $0.respRateBpm }),
            Signal(id: "sleep", name: String(localized: "Sleep"),
                   value: sleepMin.map { String(format: "%.1f", $0 / 60) } ?? "—", unit: "h",
                   systemImage: "moon", usesStateAccent: false, tint: Color(hex: "#F2B45C"),
        ...
        return AuraTodayReading(
            ...
            bandBatteryPercent: batteryPercent ?? 0,
            restValue: restValue,
