...
| ~~`NoopPalette.coachSurfaceTop`~~ | ~~`#18211E`~~ | **Deleted 8 September — a dead token.** No source uses it. |
| ~~`NoopPalette.coachSurfaceBottom`~~ | ~~`#121615`~~ | **Deleted 8 September.** The coach card is the 158° directional accent card: `rgba(139,153,214,.16) → rgba(139,153,214,.03)` over a 0.5 pt `rgba(139,153,214,.30)` border. `10-tokens.md` §*Gradients and shadows, as built* §3. And the app does not have "one card gradient" — it has a registry of six. |
...
| `NoopPalette.textDim` | `#57605C` | faint |
...
| — | **The orb durations are not in `NoopPalette`.** They are `NoopSpecMotion.breathDuration` **16** s, `.breathPhase` 4 s, `.sheenDuration` 24 s. This file said 6 s and the motion file said 16; the breath is 16 |
