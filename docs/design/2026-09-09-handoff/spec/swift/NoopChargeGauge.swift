    ...
    public var body: some View {
        ...
        .onAppear {
            ...
            if reduceMotion {
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 1.15) { arrived = true }
            }
        }
...
public struct NoopStrapBatteryChip: View {
    ...
    /// CLAMPED AT BOTH ENDS. CoreBluetooth reports 0–100 and a disconnected strap reports −1; an
    /// unclamped −1 draws a negative-width fill and prints −100 %.
    private var pct: Double { min(max(level, 0), 1) }
                    ...
                    RoundedRectangle(cornerRadius: 3.4, style: .continuous)
                        ...
                        .overlay(alignment: .leading) {
                            RoundedRectangle(cornerRadius: 2.2, style: .continuous)
                                ...
                                .frame(width: (21 - 2.4) * pct, height: 11 - 2.4)
                                .padding(.leading, 1.2)
                        }
