...
public extension NoopSpecType {
    ...
    enum Role {
        ...
        public static let rowLabel    = NoopRole(face: Face.sansRegular, size: 13.5, textStyle: .subheadline, cap: .accessibility3)
        public static let rowLabelStrong = NoopRole(face: Face.sansSemiBold, size: 13.5, textStyle: .subheadline, cap: .accessibility3)
        public static let body        = NoopRole(face: Face.sansRegular, size: 13.5, textStyle: .footnote, cssLineHeight: 1.5, cap: .accessibility3)
        public static let bodySmall   = NoopRole(face: Face.sansRegular, size: 13, textStyle: .footnote, cssLineHeight: 1.55, cap: .accessibility3)
        public static let buttonLabel = NoopRole(face: Face.sansSemiBold, size: 12.5, textStyle: .footnote, cap: .accessibility2)
        public static let subline     = NoopRole(face: Face.sansRegular, size: 11.5, textStyle: .caption, cssLineHeight: 1.45, cap: .accessibility3)
        public static let finePrint   = NoopRole(face: Face.sansRegular, size: 11, textStyle: .caption, cssLineHeight: 1.55, cap: .accessibility3)
        ...
        public static let serifNote     = NoopRole(face: Face.serifRegular, size: 16.5, textStyle: .body, cssLineHeight: 1.45, cap: .accessibility2)
        public static let serifEmphasis = NoopRole(face: Face.serifItalic, size: 16, textStyle: .body, cap: .accessibility2)
    }
}
